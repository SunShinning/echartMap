...
var BJData = [
    [{name:'成都'}, {name:'广元',value:95,Cpvalue:"<br>邮政:(1-2)天<br>"+"中通：(1-3)天<br>"}],

    [{name:'成都'},{name:'绵阳',value:95,Cpvalue:"<br>邮政:（1）天<br>"+"中通：(1-2)天<br>"}],
    [{name:'成都'},{name:'雅安',value:95,Cpvalue:"<br>邮政:（1-1）天<br>"+"中通：(1-2)天<br>"}],
];

var SHData = [
    [{name:'成都'},{name:'德阳',value:95,Cpvalue:"<br>邮政:(1-2)天<br>"+"中通：(1-2)天<br>"}],

    [{name:'成都'}, {name:'阿坝州',value:95,Cpvalue:"<br>邮政:(1-2)天<br>"+"中通：(1-2)天<br>"}],
    [{name:'成都'},{name:'达州',value:95,Cpvalue:"<br>邮政:(1-2)天<br>"+"中通：(1-2)天<br>"}],
    [{name:'成都'},{name:'巴中',value:95,Cpvalue:"<br>邮政:（1-2）天<br>"+"中通：(1-2)天<br>"}],
];

var GZData = [

    [{name:'成都'},{name:'泸州',value:95,Cpvalue:"<br>邮政:(2)天<br>"+"中通：(1)天<br>"}],
    [{name:'成都'},{name:'攀枝花',value:95,Cpvalue:"<br>邮政:(1-3)天<br>"+"中通：(1-2)天<br>"}],
